...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card/70 backdrop-blur-2xl border-white/[0.08] p-6 shadow-[0_12px_48px_oklch(0_0_0/0.4)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
